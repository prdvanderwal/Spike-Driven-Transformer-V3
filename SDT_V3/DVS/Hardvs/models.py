...
def spikformer_6_320_CAFormer_HARDVS(**kwargs):
    model = Spiking_vit_MetaFormer(
        img_size_h=224,
        img_size_w=224,
        patch_size=16,
        # embed_dim=[96, 192, 384, 480],
         embed_dim=[80, 160, 320, 400],
        num_heads=8,
        mlp_ratios=4,
        in_channels=2,
        num_classes=300,
...
def spikformer_8_384_CAFormer_HARDVS(**kwargs):
    model = Spiking_vit_MetaFormer(
        img_size_h=224,
        img_size_w=224,
        patch_size=16,
...
def spikformer_8_512_CAFormer_HARDVS(**kwargs):
    model = Spiking_vit_MetaFormer(
        img_size_h=224,
        img_size_w=224,
        patch_size=16,
...
def spikformer_6_320_CAFormer_CIFAR10DVS(**kwargs):
    model = Spiking_vit_MetaFormer(
        img_size_h=64,
        img_size_w=64,
        patch_size=16,
